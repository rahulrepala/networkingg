...
class ViewInvestorsProfile extends StatefulWidget {
  @override
  _ViewInvestorsProfileState createState() => _ViewInvestorsProfileState();
}

class _ViewInvestorsProfileState extends State<ViewInvestorsProfile> {
  @override
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                           Text('Deal Terms -',style: TextStyle(fontWeight: FontWeight.bold),),
                           SizedBox(height:15),
                               ...
                               return Padding(
                                 ...
                                 child: Transform(
                                    ...
                                    child: ListTile(
                                     ...
                                     radius: 30.0,
                                     backgroundImage:
                                           NetworkImage("https://pngimg.com/uploads/steve_jobs/steve_jobs_PNG33450.png"),
                                     backgroundColor: Colors.transparent,
                                        ),
